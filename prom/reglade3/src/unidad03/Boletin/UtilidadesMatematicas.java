...
//		}
	...
	/**
	 * Da la posición de la primera ocurrencia de u dígito dentro de un número
	 * entero. Si no encuentra, devuleve -1.
	 * Ejemplo: numereo=5678 digito=7 posición=2
	 * @param numero
	 * @param digito
	 * @return posicion
	 * 
	 */
	public static int posiciondeDigito(Long numero, Integer digito) {
		
		int posicion = -1;
		boolean encontrado=false;
		int indice=1;		
		long numAux= numero;
		while(!encontrado && indice < digitos(numero)) {
