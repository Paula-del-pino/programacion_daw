...
public class Utilidades {
		...
		public static int dameEntero() throws UtilidadesParametroTipoIncorrectoException {
			try {
				...
				throw new UtilidadesParametroTipoIncorrectoException("Debde introducir un valor entero");
			}
		}
		...
		public static LocalDate dameFecha() throws UtilidadesParametroTipoIncorrectoException {
			...
			try {	
				...
				throw new UtilidadesParametroTipoIncorrectoException("Debe introducir una fecha válida");
			}
			return fecha;
		}
